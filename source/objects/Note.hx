...
class Note extends FlxSprite
{
	...
	**/
	...
	public function ladybug(newSpeed:Float = 1)
	{
		if (speed != newSpeed)
			speed = newSpeed;
		if (lastSpeed != speed)
		{
			...
			{
				scale.y = (0.45 * lastSpeed * sustainLength) / frameHeight;
				updateHitbox();
			}
		}
	}
	...
	public function followStrumNote(myStrum:StrumNote, fakeCrochet:Float, songSpeed:Float = 1)
	{
		...
		distance = (0.45 * (strumTime - Conductor.songPosition) * lastSpeed);

		ladybug(songSpeed * multSpeed);
